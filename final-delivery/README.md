...
| 交付项 | 当前状态 | 完成门禁 |
|---|---|---|
| 专项研究报告 | 已写入P03双轨、URFD复核和三人黄金闭环结果 | 消融、12小时、实机闭环和正式PDF |
| 演示视频 | 脚本和镜头清单 | 补拍、旁白、字幕、来源标签和脱敏完成 |
| Windows程序 | ZIP已构建，本机全栈冒烟和清单复核通过 | 在另一台Windows电脑验收 |
| 系统/接口/部署文档 | 工作底稿 | 与最终发布包和规则版本一致 |
| 测试报告 | 已写入P03、URFD和三人黄金闭环结果 | 消融、12小时、异机Windows验收 |
| 隐私材料 | 模板和边界已建立 | 三人签字及删除日期确认 |
| 提交门禁 | 草稿包可生成，最终模式会拒绝缺项 | 所有真实证据完成后状态变为READY |

正式文档源稿位于 `docs/`，07/08 号新增源稿位于 `official-docs/`，演示视频材料位于 `video/`。P01/P02全量演练、P03一次性盲测、URFD独立复核和三人黄金闭环均已归档；当前仍不是可提交终稿，必须继续补齐外部证据和剩余门禁。
