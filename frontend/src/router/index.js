...
const routes = [
  ...
  { path: '/system', name: 'system', component: PrototypeView, meta: { title: '系统和设备状态', nav: true, icon: 'Monitor', description: '展示设备在线状态、适配器模式、数据质量和未核验能力。' } },
  { path: '/replay', name: 'replay', component: PrototypeView, meta: { title: '场景回放', nav: true, icon: 'VideoPlay', description: '按故事顺序回放100天关键场景，并清楚标记真实、回放、公开数据或Mock来源。' } },
